...
(function () {
  ...
  class LoaderShim {
      constructor(global) {
          ...
          this.loaderModule = 'lwr/loaderLegacy/v/0_9_4';
      ...
      createProfilerModule(globalLWR) {
          ...
          globalLWR.define('lwr/profiler/v/0_9_4', ['exports'], exporter, {});
      }
  ...
  if (GLOBAL.LWR.requiredModules.indexOf('lwr/loaderLegacy/v/0_9_4') < 0) {
      GLOBAL.LWR.requiredModules.push('lwr/loaderLegacy/v/0_9_4');
  }
  new LoaderShim(GLOBAL);

}());

LWR.define('lwr/loaderLegacy/v/0_9_4', ['exports'], function (exports) { 'use strict';
