...
} = Boolean.prototype; // Locker build constants.
...
}()}`.includes('LOCKER_UNMINIFIED_FLAG'); // Locker key constants.

const LOCKER_SERVICE_KEY$LWS = 'LSKey';
const LOCKER_SERVICE_KEY_LOWERED$LWS = 'lskey'; // Character constants.
const CHAR_QUOTE_DOUBLE$LWS = '"';
const CHAR_QUOTE_SINGLE$LWS = "'"; // Compiler constants.
...
const WEBPACK_REQUIRE_NAME$LWS = '__webpack_require__'; // Error message constants.

const ERR_ILLEGAL_PROPERTY_ACCESS$LWS = 'Illegal property access.';
const ERR_INVALID_SANDBOX_KEY$LWS = 'Invalid sandbox key.'; // Near-membrane constants.
...
const LOCKER_NEAR_MEMBRANE_SYMBOL$LWS$1 = SymbolFor$LWS$1('@@lockerNearMembrane'); // Legacy symbol used by packages/locker-core-engine/src/LockerFilter.js.

const SYMBOL_LIVE_OBJECT$LWS = SymbolFor$LWS$1('@@lockerLiveValue'); // Object brand constants.
...
const TO_STRING_BRAND_WEAK_SET$LWS = '[object WeakSet]'; // Sandbox constants.
...
} = DateCtor$LWS.prototype; // Used by '@locker/near-membrane-base'
...
function proxyMaskFunction$LWS(func$LWS, maskFunc$LWS, trapInvokers$LWS) {
  ...
  const proxy$LWS = new ProxyCtor$LWS(maskFunc$LWS, {
    ...
    get(target$LWS, key$LWS, receiver$LWS) {
      ...
      const result$LWS = getTrapInvoker$LWS(target$LWS, key$LWS, receiver$LWS, handshakeFlag$LWS); // Getting forged values of handshake properties is not allowed.
    ...
    getOwnPropertyDescriptor(target$LWS, key$LWS) {
      ...
      /* ProxyHandlerTraps.GetOwnPropertyDescriptor */
      ;
      const result$LWS = getOwnPropertyDescriptorTrapInvoker$LWS(target$LWS, key$LWS); // Getting forged descriptors of handshake properties is not allowed.
    ...
    has(target$LWS, key$LWS) {
      ...
      if (result$LWS) {
        handshakeFlag$LWS = false; // Checking the existence of forged handshake properties is not allowed.
...
const NodeProtoIsConnectedGetter$LWS = ObjectLookupOwnGetter$LWS$1(NodeProto$LWS$1, 'isConnected'); // Used by '@locker/near-membrane-dom'.
...
const CUSTOM_ELEMENT_REGISTRY_ATTRIBUTE_NAME$LWS = LOCKER_SERVICE_KEY_LOWERED$LWS; // Used by '@locker/near-membrane-dom'.
...
ReflectGetOwnPropertyDescriptor$LWS(SVGScriptElement.prototype, 'href'); // This has to be done 1-by-1 because putting a full file ignore in this file
...
function createSantizerHooksRegistry$LWS(sandboxKey$LWS) {
  return {
    ...
    uponSanitizeElement(node$LWS, data$LWS, config$LWS) {
      ...
      if (tagNameCheck$LWS && ReflectApply$LWS$1(RegExpProtoTest$LWS$1, tagNameCheck$LWS, [tagName$LWS]) && // This MUST be called ONLY after we've ensured the previous
...
function fetchAndSanitize$LWS(normalizedHref$LWS) {
  ...
  ReflectApply$LWS$1(EventTargetProtoAddEventListener$LWS, xhr$LWS, ['load', () => {
    ...
    if (status$LWS === 200) {
      ...
      const responseText$LWS = ReflectApply$LWS$1(XhrProtoResponseTextGetter$LWS, xhr$LWS, []); // eslint-disable-next-line @typescript-eslint/no-use-before-define
...
function parseHref$LWS(url$LWS) {
  ...
  const loweredUrl$LWS = ReflectApply$LWS$1(StringProtoToLowerCase$LWS, requestedURL$LWS, []); // RegExp.prototype[Symbol.replace] resets the lastIndex of global regexp to 0.
...
function sanitizeSvgInnerHtml$LWS(stringOrSvg$LWS, dirty$LWS = '') {
  ...
  const replacedOuterHTML$LWS = ReflectApply$LWS$1(StringProtoReplace$LWS, outerHTML$LWS, ['<!---->', dirty$LWS]); // eslint-disable-next-line @typescript-eslint/no-use-before-define
...
class VirtualRegistry$LWS {
  ...
  newCtor(instance$LWS) {
    ...
    if (definition$LWS === undefined || typeof definition$LWS.PivotCtor !== 'function') {
      ...
      try {
        tagName$LWS = ReflectApply$LWS$1(ElementProtoTagNameGetter$LWS, instance$LWS, []); // eslint-disable-next-line no-empty
...
function getNodeRegistry$LWS(document$LWS, node$LWS) {
  ...
  const ownerDoc$LWS = ReflectApply$LWS$1(NodeProtoOwnerDocumentGetter$LWS, node$LWS, []); // istanbul ignore if: it's unclear how this could actually happen, if the node is coming from parsed/sanitized html.
...
function getObservedAttributesList$LWS(baseDefinition$LWS, sourceDefinition$LWS) {
  ...
  return toSafeSet$LWS(new SetCtor$LWS$1([...sourceDefinition$LWS.observedAttributes].filter( // `baseDefinition.observedAttributes` is a safe Set.
  ...
  return function distortionDOMParserParseFromString$LWS({
    ...
    return [originalParseFromString$LWS, function parseFromString$LWS(...args$LWS) {
      ...
      if (args$LWS.length >= 2) {
        ...
        mimeType$LWS === 'application/xhtml+xml' || mimeType$LWS === 'application/xml' || mimeType$LWS === 'text/xml' ? lwsInternalPolicy.createHTML(string$LWS, key$LWS, 2
        /* ContentType.XML */
        ) : lwsInternalPolicy.createHTML(string$LWS, key$LWS, 0
        /* ContentType.HTML */
        );
      }
...
function initDistortionEventPathGetter$LWS({
  ...
  const originalPathGetter$LWS = ObjectLookupOwnGetter$LWS$1(Event$LWS.prototype, 'path'); // Chromium 109 removed Event.prototype.path:
...
function initDistortionJSONParse$LWS({
  ...
  return function distortionJSONParse$LWS({
    ...
    return [originalParse$LWS, function parse$LWS(...args$LWS) {
      ...
      return ReflectApply$LWS$1(originalParse$LWS, this, [text$LWS, // eslint-disable-next-line no-shadow
        ...
        if (!isScriptEvaluated$LWS(this)) {
          ...
          if (!isScriptURLEvaluatorHookDefined$LWS(this)) {
            defineScriptEvaluatorProperty$LWS(this, (context$LWS, defaultView$LWS, ownerDoc$LWS) => {
              ...
              ReflectDeleteProperty$LWS$1(this, 'textContent'); // Set the script's textContent immediately
...
function initDistortionXMLHttpRequestResponseGetter$LWS({
  ...
  return function distortionXMLHttpRequestResponseGetter$LWS({
    ...
    return [originalResponseGetter$LWS, function response$LWS() {
      const rawResponse$LWS = ReflectApply$LWS$1(originalResponseGetter$LWS, this, []); // This must be called to signal to the virtual
      // CustomElementRegistry that the next thing created
      // MAY CONTAIN a custom element, which must be marked for
      // association to this sandbox.
...
function initDistortionXMLHttpRequestResponseXMLGetter$LWS({
  ...
  return function distortionXMLHttpRequestResponseXMLGetter$LWS({
    ...
    return [originalResponseXMLGetter$LWS, function responseXML$LWS() {
      const rawResponseXML$LWS = ReflectApply$LWS$1(originalResponseXMLGetter$LWS, this, []); // This must be called to signal to the virtual
      // CustomElementRegistry that the next thing created
      // MAY CONTAIN a custom element, which must be marked for
      // association to this sandbox.
...
export { CORE_SANDBOX_KEY$LWS as CORE_SANDBOX_KEY, createRootWindowSandboxRecord$LWS as createRootWindowSandboxRecord, evaluateInCoreSandbox$LWS as evaluateInCoreSandbox, evaluateInSandbox$LWS as evaluateInSandbox, trusted };
