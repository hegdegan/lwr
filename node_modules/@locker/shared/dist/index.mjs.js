...
const LOCKER_NEAR_MEMBRANE_PROXY_MASKED_SYMBOL$LWS = SymbolFor$LWS('@@lockerNearMembraneProxyMasked');
const LOCKER_NEAR_MEMBRANE_SERIALIZED_VALUE_SYMBOL$LWS = SymbolFor$LWS('@@lockerNearMembraneSerializedValue');
const LOCKER_NEAR_MEMBRANE_SYMBOL$LWS = SymbolFor$LWS('@@lockerNearMembrane'); // Legacy symbol used by packages/locker-core-engine/src/LockerFilter.js.

const SYMBOL_LIVE_OBJECT$LWS = SymbolFor$LWS('@@lockerLiveValue'); // Object brand constants.
