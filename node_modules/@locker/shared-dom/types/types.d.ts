...
export interface AttributeNameToResolvedURLRegistry {
    [key: string]: string;
}
...
export interface CompilationTransforms {
    location: boolean;
    windowTop: boolean;
}
...
export declare type ScriptElement = HTMLScriptElement | SVGScriptElement;
export declare type ScriptEvaluatorPropertyCallback = (context: any, globalObject: GlobalObject, document: Document) => void;
