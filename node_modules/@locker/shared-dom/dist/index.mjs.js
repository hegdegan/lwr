...
const NodeProtoIsConnectedGetter$LWS = ObjectLookupOwnGetter$LWS(NodeProto$LWS, 'isConnected'); // Used by '@locker/near-membrane-dom'.
...
ReflectApply$LWS(RegExpProtoTest$LWS, chromiumUserAgentRegExp$LWS, [getUserAgent$LWS()]); // Used by '@locker/near-membrane-dom'.
...
const HTMLAnchorElementProtoProtocolGetter$LWS = ObjectLookupOwnGetter$LWS(HTMLAnchorElement.prototype, 'protocol'); // Used by '@locker/near-membrane-dom'.
...
const originalTextContentCache$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
...
function defineScriptEvaluatorProperty$LWS(script$LWS, callback$LWS) {
  if (!ReflectDefineProperty$LWS(script$LWS, SCRIPT_EVALUATOR_PROPERTY_NAME$LWS, {
    ...
    get: ReflectApply$LWS(FunctionProtoBind$LWS, () => {
      ...
      const defaultView$LWS = ReflectApply$LWS(DocumentProtoDefaultViewGetter$LWS, ownerDoc$LWS, []); // We don't need to use something like `WindowLocationGetter()`
