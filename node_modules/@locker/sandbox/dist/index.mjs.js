 ...
 */
import { SymbolFor as SymbolFor$1$LWS, toSafeWeakMap as toSafeWeakMap$1$LWS, WeakMapCtor as WeakMapCtor$1$LWS, toSafeMap as toSafeMap$1$LWS, MapCtor as MapCtor$1$LWS, isProxyMaskedFunction as isProxyMaskedFunction$LWS, TypeErrorCtor as TypeErrorCtor$1$LWS, ReflectGetOwnPropertyDescriptor as ReflectGetOwnPropertyDescriptor$LWS, ReflectSetPrototypeOf as ReflectSetPrototypeOf$1$LWS, ObjectLookupOwnGetter as ObjectLookupOwnGetter$1$LWS, toSafeArray as toSafeArray$1$LWS, ArrayConcat as ArrayConcat$LWS, proxyMaskFunction as proxyMaskFunction$LWS, PromiseReject as PromiseReject$LWS, ERR_ILLEGAL_PROPERTY_ACCESS as ERR_ILLEGAL_PROPERTY_ACCESS$LWS, ReflectDefineProperty as ReflectDefineProperty$1$LWS, ReflectGet as ReflectGet$LWS, ReflectHas as ReflectHas$LWS, ReflectSet as ReflectSet$LWS, ObjectLookupOwnSetter as ObjectLookupOwnSetter$LWS, ReflectApply as ReflectApply$1$LWS, noop as noop$1$LWS, StringProtoSplit as StringProtoSplit$LWS, StringProtoReplace as StringProtoReplace$LWS, isConvertibleToString as isConvertibleToString$LWS, prependNamespaceMarker as prependNamespaceMarker$LWS, PromiseProtoThen as PromiseProtoThen$LWS, startsWithNamespaceMarker as startsWithNamespaceMarker$LWS, removeNamespaceMarker as removeNamespaceMarker$LWS, isObjectLike as isObjectLike$LWS, shallowCloneOptions as shallowCloneOptions$LWS, LockerSecurityError as LockerSecurityError$LWS, ArrayProtoJoin as ArrayProtoJoin$1$LWS, StringProtoSlice as StringProtoSlice$1$LWS, StringProtoIncludes as StringProtoIncludes$LWS, toString as toString$LWS, StringProtoToLowerCase as StringProtoToLowerCase$LWS, enquote as enquote$LWS, capitalizeFirstChar as capitalizeFirstChar$LWS, toSafeTemplateStringValue as toSafeTemplateStringValue$LWS, trackAsLiveTarget as trackAsLiveTarget$LWS, ReflectDeleteProperty as ReflectDeleteProperty$1$LWS, createRevokedProxy as createRevokedProxy$LWS, toSafeSet as toSafeSet$LWS, SetCtor as SetCtor$1$LWS, PromiseCtor as PromiseCtor$LWS, ReflectConstruct as ReflectConstruct$LWS, isObject as isObject$1$LWS, getNamespaceMarker as getNamespaceMarker$LWS, ObjectAssign as ObjectAssign$1$LWS, ReflectGetPrototypeOf as ReflectGetPrototypeOf$1$LWS, partialStructuredClone as partialStructuredClone$LWS, consoleWarn as consoleWarn$LWS, removeStorageNamespaceMarker as removeStorageNamespaceMarker$LWS, prependStorageNamespaceMarker as prependStorageNamespaceMarker$LWS, toSafeWeakSet as toSafeWeakSet$1$LWS, WeakSetCtor as WeakSetCtor$1$LWS, shallowCloneArray as shallowCloneArray$LWS, RegExpProtoTest as RegExpProtoTest$1$LWS, ArrayProtoIndexOf as ArrayProtoIndexOf$1$LWS, ArrayProtoSlice as ArrayProtoSlice$1$LWS, ObjectKeys as ObjectKeys$1$LWS, startsWithStorageNamespaceMarker as startsWithStorageNamespaceMarker$LWS, FunctionProtoBind as FunctionProtoBind$LWS, ProxyCtor as ProxyCtor$LWS, UNCOMPILED_LOCATION_NAME as UNCOMPILED_LOCATION_NAME$LWS, UNCOMPILED_TOP_NAME as UNCOMPILED_TOP_NAME$LWS, ObjectHasOwn as ObjectHasOwn$1$LWS, ObjectGetOwnPropertySymbols as ObjectGetOwnPropertySymbols$LWS, ArrayCtor as ArrayCtor$1$LWS, ObjectGetOwnPropertyDescriptors as ObjectGetOwnPropertyDescriptors$LWS, NumberIsInteger as NumberIsInteger$1$LWS, ObjectLookupOwnValue as ObjectLookupOwnValue$LWS, LOCKER_IDENTIFIER_MARKER as LOCKER_IDENTIFIER_MARKER$LWS, SANDBOX_EVAL_CONTEXT_NAME as SANDBOX_EVAL_CONTEXT_NAME$LWS, SANDBOX_EVAL_HELPERS_NAME as SANDBOX_EVAL_HELPERS_NAME$LWS, PromiseResolve as PromiseResolve$LWS, SymbolAsyncIterator as SymbolAsyncIterator$LWS, SymbolIterator as SymbolIterator$1$LWS, extractFunctionBodySource as extractFunctionBodySource$LWS, indexOfPragma as indexOfPragma$LWS, ReflectOwnKeys as ReflectOwnKeys$1$LWS, ERR_INVALID_SANDBOX_KEY as ERR_INVALID_SANDBOX_KEY$LWS, FunctionProtoToString as FunctionProtoToString$LWS, isTargetLive as isTargetLive$LWS, LOCKER_UNMINIFIED_FLAG as LOCKER_UNMINIFIED_FLAG$1$LWS } from '@locker/shared';
import { AttrProtoOwnerElementGetter as AttrProtoOwnerElementGetter$LWS, AttrProtoNameGetter as AttrProtoNameGetter$LWS, AttrProtoNamespaceURIGetter as AttrProtoNamespaceURIGetter$LWS, transformSourceText as transformSourceText$LWS, DocumentProtoCookieGetter as DocumentProtoCookieGetter$LWS, DocumentProtoCookieSetter as DocumentProtoCookieSetter$LWS, NodeProtoNodeNameGetter as NodeProtoNodeNameGetter$LWS, NodeProtoOwnerDocumentGetter as NodeProtoOwnerDocumentGetter$LWS, ElementProtoGetAttributeNode as ElementProtoGetAttributeNode$LWS, ElementProtoRemoveAttributeNode as ElementProtoRemoveAttributeNode$LWS, AttrProtoValueGetter as AttrProtoValueGetter$LWS, AttrProtoValueSetter as AttrProtoValueSetter$LWS, ElementProtoGetAttributeNodeNS as ElementProtoGetAttributeNodeNS$LWS, isTextContentEvaluatorHookDefined as isTextContentEvaluatorHookDefined$LWS, defineScriptAccessorProperty as defineScriptAccessorProperty$LWS, setOriginalScriptTextContent as setOriginalScriptTextContent$LWS, isScriptEvaluated as isScriptEvaluated$LWS, isScriptURLEvaluatorHookDefined as isScriptURLEvaluatorHookDefined$LWS, defineScriptEvaluatorProperty as defineScriptEvaluatorProperty$LWS, deleteOriginalTextContent as deleteOriginalTextContent$LWS, SCRIPT_HOOK_SOURCE_TEXT as SCRIPT_HOOK_SOURCE_TEXT$LWS, NAMESPACE_XLINK as NAMESPACE_XLINK$LWS, getValidator as getValidator$LWS, BlobProtoTypeGetter as BlobProtoTypeGetter$LWS, BlobProtoSlice as BlobProtoSlice$LWS, BlobProtoSizeGetter as BlobProtoSizeGetter$LWS, URLRevokeObjectURL as URLRevokeObjectURL$LWS, XhrCtor as XhrCtor$LWS, XhrProtoOpen as XhrProtoOpen$LWS, XhrProtoSend as XhrProtoSend$LWS, XhrProtoResponseTextGetter as XhrProtoResponseTextGetter$LWS, CustomElementRegistryProtoDefine as CustomElementRegistryProtoDefine$LWS, CustomElementRegistryProtoGet as CustomElementRegistryProtoGet$LWS, CustomElementRegistryProtoWhenDefined as CustomElementRegistryProtoWhenDefined$LWS, ElementProtoTagNameGetter as ElementProtoTagNameGetter$LWS, NodeProtoIsConnectedGetter as NodeProtoIsConnectedGetter$LWS, ElementProtoGetAttribute as ElementProtoGetAttribute$LWS, ElementProtoRemoveAttribute as ElementProtoRemoveAttribute$LWS, ElementProtoSetAttribute as ElementProtoSetAttribute$1$LWS, ElementProtoHasAttribute as _ElementProtoHasAttribute$LWS, ElementProtoToggleAttribute as ElementProtoToggleAttribute$LWS, NAMESPACE_DEFAULT as NAMESPACE_DEFAULT$LWS, rootValidator as rootValidator$LWS, DocumentProtoHeadGetter as DocumentProtoHeadGetter$LWS, DOMTokenListProtoValueGetter as DOMTokenListProtoValueGetter$LWS, getOriginalScriptTextContent as getOriginalScriptTextContent$LWS, StorageProtoKey as StorageProtoKey$LWS, StorageProtoGetItem as StorageProtoGetItem$LWS, StorageProtoSetItem as StorageProtoSetItem$LWS, StorageProtoRemoveItem as StorageProtoRemoveItem$LWS, RequestProtoURLGetter as RequestProtoURLGetter$LWS, CUSTOM_ELEMENT_REGISTRY_ATTRIBUTE_NAME as CUSTOM_ELEMENT_REGISTRY_ATTRIBUTE_NAME$LWS, EventProtoCurrentTargetGetter as EventProtoCurrentTargetGetter$LWS, HTMLIFrameElementProtoSrcSetter as HTMLIFrameElementProtoSrcSetter$LWS, WindowLengthGetter as WindowLengthGetter$LWS, DocumentProtoDefaultViewGetter as DocumentProtoDefaultViewGetter$LWS, isWindow as isWindow$LWS, IS_WEBKIT_BROWSER as IS_WEBKIT_BROWSER$LWS, rootWindowLocation as rootWindowLocation$LWS, topWindow as topWindow$LWS, HTMLScriptElementProtoSrcGetter as HTMLScriptElementProtoSrcGetter$LWS, HTMLScriptElementProtoSrcSetter as HTMLScriptElementProtoSrcSetter$LWS, ElementProtoQuerySelectorAll as ElementProtoQuerySelectorAll$LWS, DocumentProtoCreateElement as DocumentProtoCreateElement$1$LWS, ElementProtoQuerySelector as ElementProtoQuerySelector$LWS, EventTargetProtoAddEventListener as EventTargetProtoAddEventListener$LWS, NodeProtoAppendChild as NodeProtoAppendChild$1$LWS, EventTargetProtoRemoveEventListener as EventTargetProtoRemoveEventListener$LWS, EventProtoStopPropagation as EventProtoStopPropagation$LWS, rootDocument as rootDocument$LWS, rootWindow as rootWindow$1$LWS, WindowFrameElementGetter as WindowFrameElementGetter$LWS, WindowQueueMicrotask as WindowQueueMicrotask$LWS, WindowDocumentGetter as WindowDocumentGetter$LWS, WindowLocationGetter as WindowLocationGetter$LWS } from '@locker/shared-dom';
import { lwsInternalPolicy as lwsInternalPolicy$LWS, trusted as trusted$LWS } from '@locker/trusted-types';
export { trusted } from '@locker/trusted-types';
import { sanitizeSvgInnerHtml as sanitizeSvgInnerHtml$LWS, sanitize as sanitize$LWS, blobSanitizer as blobSanitizer$LWS, sanitizeDocument as sanitizeDocument$LWS, sanitizeSvgHref as sanitizeSvgHref$LWS } from '@locker/html-sanitizer';
import { isMIMETypeAllowed as isMIMETypeAllowed$LWS, parseURL as parseURL$LWS, isValidURL as isValidURL$LWS, sanitizeURLForElement as sanitizeURLForElement$LWS, isValidURLScheme as isValidURLScheme$LWS, resolveURL as resolveURL$LWS } from '@locker/shared-url';
...
const LOCKER_ORIGINAL_HTML_ELEMENT_CTOR_SYMBOL$LWS = SymbolFor$1$LWS('@@lockerOriginalHTMLElementCtor');
let currentRegistry$LWS;
let currentUpgradingInstance$LWS;
const definitionCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
const originalHTMLElementCtorCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
const globalRegistryCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
const pivotCtorCache$LWS = toSafeMap$1$LWS(new MapCtor$1$LWS());
const sandboxRegistryCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
/* eslint-disable no-underscore-dangle */

class VirtualRegistry$LWS {
  constructor(document$LWS) {
    this._awaitingUpgrade = toSafeMap$1$LWS(new MapCtor$1$LWS());
    this._definedCtors = toSafeSet$LWS(new SetCtor$1$LWS());
    this._definitionByElement = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
    this._definitionByTag = toSafeMap$1$LWS(new MapCtor$1$LWS());
    this._pendingRegistryByElement = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
  ...
  applyDefine(cer$LWS, args$LWS) {
    ...
    if (PivotCtor$LWS === undefined) {
      PivotCtor$LWS = createPivotingClass$LWS(this._document, this._HTMLElement, definition$LWS, tagName$LWS); // Register a pivoting class which will handle global registry initializations.

      ReflectApply$1$LWS(CustomElementRegistryProtoDefine$LWS, cer$LWS, [tagName$LWS, PivotCtor$LWS]);
    ...
    this._definedCtors.add(LocalCtor$LWS); // For globally defined custom elements, the definition associated
    ...
    definition$LWS.PivotCtor = PivotCtor$LWS; // Immediately upgrade any elements created in this scope before define was called,
    ...
    if (awaiting$LWS) {
      awaiting$LWS.forEach(element$LWS => {
        const originalDefinition$LWS = this._pendingRegistryByElement.get(element$LWS); // istanbul ignore else: it is unnecessary to cover the else path here
  ...
  applyGet(cer$LWS, args$LWS) {
    ...
    return definition$LWS && definition$LWS.LocalCtor || ReflectApply$1$LWS(CustomElementRegistryProtoGet$LWS, cer$LWS, [tagName$LWS]);
  }
  ...
  applyWhenDefined(cer$LWS, args$LWS) {
    ...
    const promise$LWS = ReflectApply$1$LWS(CustomElementRegistryProtoWhenDefined$LWS, cer$LWS, args$LWS);
    return new PromiseCtor$LWS((resolve$LWS, reject$LWS) => {
      ReflectApply$1$LWS(PromiseProtoThen$LWS, promise$LWS, [() => {
        const definition$LWS = this._definitionByTag.get(tagName$LWS);
  ...
  newCtor(instance$LWS) {
    ...
    if (definition$LWS === undefined || typeof definition$LWS.PivotCtor !== 'function') {
      let tagName$LWS; // If we can get a tagName without triggering "Illegal invocation", then
      ...
      try {
        tagName$LWS = ReflectApply$1$LWS(ElementProtoTagNameGetter$LWS, instance$LWS, []); // eslint-disable-next-line no-empty
      } catch (_unused$LWS) {} // If we successfully got the tagName, we can return this instance
      ...
      throw new TypeErrorCtor$1$LWS(ERR_ILLEGAL_CONSTRUCTOR$LWS);
  ...
  scheduleConnectedCallback(instance$LWS, tagName$LWS) {
    ...
    if (awaiting$LWS === undefined) {
      awaiting$LWS = toSafeSet$LWS(new SetCtor$1$LWS());
  ...
  scheduleDisconnectedCallback(instance$LWS, tagName$LWS) {
    ...
    const awaiting$LWS = this._awaitingUpgrade.get(tagName$LWS); // istanbul ignore else: currently unreachable via tests
  ...
  scheduleOrUpgrade(instance$LWS, tagName$LWS, originalDefinition$LWS) {
    ...
    if (definition$LWS) {
      ...
      this._pendingRegistryByElement.set(instance$LWS, originalDefinition$LWS); // We need to install the minimum HTMLElement prototype so that
      ...
      ReflectSetPrototypeOf$1$LWS(instance$LWS, this._HTMLElement.prototype);
    }
  }

  setDefinition(instance$LWS, pivotDefinition$LWS) {
    ReflectSetPrototypeOf$1$LWS(instance$LWS, pivotDefinition$LWS.LocalCtor.prototype);
  ...
  upgrade(instance$LWS, originalDefinition$LWS, pivotDefinition$LWS) {
    ...
    this.setDefinition(instance$LWS, pivotDefinition$LWS); // This path will be taken when any _globally_ registered tag name has
    ...
    const tagName$LWS = ReflectApply$1$LWS(ElementProtoTagNameGetter$LWS, instance$LWS, []);
    const tagNameLowerCased$LWS = ReflectApply$1$LWS(StringProtoToLowerCase$LWS, tagName$LWS, []);

    const awaiting$LWS = this._awaitingUpgrade.get(tagNameLowerCased$LWS);

    if (awaiting$LWS && awaiting$LWS.size) {
      triggerAttributeChangedCallbackDuringUpgrade$LWS(instance$LWS, originalDefinition$LWS); // @TODO: Maybe this should only be done when there is something
      // awaiting upgrade?
      // `awaiting` is a safe Set.

      const needsConnectedCallback$LWS = awaiting$LWS.has(instance$LWS); // istanbul ignore else: currently unreachable via tests

      if (needsConnectedCallback$LWS && ReflectApply$1$LWS(NodeProtoIsConnectedGetter$LWS, instance$LWS, [])) {
        if (connectedCallback$LWS) {
          ReflectApply$1$LWS(connectedCallback$LWS, instance$LWS, []);
        }
...
function createDefinitionRecord$LWS(LocalCtor$LWS) {
  ...
  const observedAttributes$LWS = toSafeSet$LWS(new SetCtor$1$LWS(LocalCtor$LWS.observedAttributes || []));
  return {
    adoptedCallback: adoptedCallback$LWS,
    attributeChangedCallback: attributeChangedCallback$LWS,
    connectedCallback: connectedCallback$LWS,
...
function createPivotingClass$LWS(document$LWS, CustomElementBaseClass$LWS, // This is the definition that user code provided to customElements.define(tagName, definition)
  ...
  return _a$LWS = class PivotCtor$LWS extends CustomElementBaseClass$LWS {
    constructor(localRegistry$LWS, definition$LWS) {
      ...
      if (localRegistry$LWS && definition$LWS) {
        ...
        this.instanceRegistry = // Usually `el.innerHTML` or any other parsing driven
        // initialization.
        getNodeRegistry$LWS(document$LWS, this) || // Usually `document.createElement()`,
        // or any DOM API that has been patched to call
        // `setCustomElementsRegistry(globalObject, key)`
        // prior to element creation.
        getCurrentRegistry$LWS() || // Global stuff.
    ...
    connectedCallback() {
      ...
      if (definition$LWS) {
        ...
        if (connectedCallback$LWS) {
          ReflectApply$1$LWS(connectedCallback$LWS, this, []);
        }
      } else {
    ...
    disconnectedCallback() {
      ...
      if (definition$LWS) {
        ...
        if (disconnectedCallback$LWS) {
          ReflectApply$1$LWS(disconnectedCallback$LWS, this, []);
        }
      } else {
    ...
    adoptedCallback() {
      const definition$LWS = this.instanceRegistry.getDefinition(this); // istanbul ignore else: currently unreachable via tests

      if (definition$LWS) {
        const {
          adoptedCallback: adoptedCallback$LWS
        } = definition$LWS; // istanbul ignore else: currently unreachable via tests

        if (adoptedCallback$LWS) {
          ReflectApply$1$LWS(adoptedCallback$LWS, this, []);
        }
      }
    }

    attributeChangedCallback(name$LWS, oldValue$LWS, newValue$LWS) {
      const definition$LWS = this.instanceRegistry.getDefinition(this); // istanbul ignore next: optional chaining and nullish coalescing results in an expansion that contains an unreachable "void 0" branch for every occurrence of the operator

      const attributeChangedCallback$LWS = definition$LWS == null ? void 0 : definition$LWS.attributeChangedCallback; // istanbul ignore next: optional chaining and nullish coalescing results in an expansion that contains an unreachable "void 0" branch for every occurrence of the operator

      const observedAttributes$LWS = definition$LWS == null ? void 0 : definition$LWS.observedAttributes; // If both definitions are the same, then the observedAttributes is the same,
      ...
      if (typeof attributeChangedCallback$LWS === 'function' && (originalDefinition$LWS === definition$LWS || observedAttributes$LWS != null && observedAttributes$LWS.has(name$LWS))) {
        ReflectApply$1$LWS(attributeChangedCallback$LWS, this, [name$LWS, oldValue$LWS, newValue$LWS]);
      }
    }
...
function getDefinitionForConstructor$LWS(LocalCtor$LWS) {
  ...
  if (!isObject$1$LWS(proto$LWS)) {
    throw new TypeErrorCtor$1$LWS('Invalid custom element constructor.');
  }
...
function getNodeRegistry$LWS(document$LWS, node$LWS) {
  const key$LWS = ReflectApply$1$LWS(ElementProtoGetAttribute$LWS, node$LWS, [CUSTOM_ELEMENT_REGISTRY_ATTRIBUTE_NAME$LWS]);

  if (key$LWS === null) {
    return undefined;
  }

  ReflectApply$1$LWS(ElementProtoRemoveAttribute$LWS, node$LWS, [CUSTOM_ELEMENT_REGISTRY_ATTRIBUTE_NAME$LWS]);
  const ownerDoc$LWS = ReflectApply$1$LWS(NodeProtoOwnerDocumentGetter$LWS, node$LWS, []); // istanbul ignore if: it's unclear how this could actually happen, if the node is coming from parsed/sanitized html.
...
function getObservedAttributesList$LWS(baseDefinition$LWS, sourceDefinition$LWS) {
  ...
  return toSafeSet$LWS(new SetCtor$1$LWS([...sourceDefinition$LWS.observedAttributes].filter( // `baseDefinition.observedAttributes` is a safe Set.
...
function patchAttributes$LWS(instance$LWS, originalDefinition$LWS, pivotDefinition$LWS) {
  const {
    observedAttributes: observedAttributes$LWS,
    attributeChangedCallback: attributeChangedCallback$LWS
  } = pivotDefinition$LWS; // istanbul ignore if: there is no way to test that nothing happens when these conditions are met

  if (observedAttributes$LWS.size === 0 || typeof attributeChangedCallback$LWS !== 'function') {
    return;
  }

  const observedAttributesList$LWS = getObservedAttributesList$LWS(originalDefinition$LWS, pivotDefinition$LWS); // If there are no unique attributes to observe, then there is no need to
  ...
  instance$LWS.removeAttribute = proxyMaskFunction$LWS(function removeAttribute$LWS(name$LWS) {
    const args$LWS = [name$LWS]; // `observedAttributesList` is a safe Set.

    if (observedAttributesList$LWS.has(name$LWS)) {
      const old$LWS = ReflectApply$1$LWS(ElementProtoGetAttribute$LWS, this, args$LWS);
      ReflectApply$1$LWS(ElementProtoRemoveAttribute$LWS, this, args$LWS);
      args$LWS[1] = old$LWS;
      args$LWS[2] = null;
      ReflectApply$1$LWS(attributeChangedCallback$LWS, this, args$LWS);
    } else {
      ReflectApply$1$LWS(ElementProtoRemoveAttribute$LWS, this, args$LWS);
    }
  ...
  instance$LWS.setAttribute = proxyMaskFunction$LWS(function setAttribute$LWS(name$LWS, value$LWS) {
    ...
    const setAttributeArgs$LWS = [name$LWS, stringifiedValue$LWS]; // `observedAttributesList` is a safe Set.

    if (observedAttributesList$LWS.has(name$LWS)) {
      const old$LWS = ReflectApply$1$LWS(ElementProtoGetAttribute$LWS, this, args$LWS);
      ReflectApply$1$LWS(ElementProtoSetAttribute$1$LWS, this, setAttributeArgs$LWS);
      args$LWS[1] = old$LWS;
  ...
  }, ElementProtoSetAttribute$1$LWS);
  instance$LWS.toggleAttribute = proxyMaskFunction$LWS(function toggleAttribute$LWS(name$LWS) {
    const args$LWS = [name$LWS];
    let returnValue$LWS; // `observedAttributesList` is a safe Set.

    if (observedAttributesList$LWS.has(name$LWS)) {
      const hasAttribute$LWS = ReflectApply$1$LWS(_ElementProtoHasAttribute$LWS, this, args$LWS);
      const old$LWS = hasAttribute$LWS ? ReflectApply$1$LWS(ElementProtoGetAttribute$LWS, this, args$LWS) : null;
      returnValue$LWS = ReflectApply$1$LWS(ElementProtoToggleAttribute$LWS, this, args$LWS);
      args$LWS[1] = old$LWS;
...
function patchCustomElementRegistry$LWS(globalObject$LWS, registry$LWS) {
  ...
  CustomElementRegistryProto$LWS.get = proxyMaskFunction$LWS(function get$LWS(...args$LWS) {
    if (this !== customElements$LWS) {
      ...
      // that's the concern.
      throw new TypeErrorCtor$1$LWS(ERR_ILLEGAL_INVOCATION$LWS);
    }
  ...
  CustomElementRegistryProto$LWS.whenDefined = proxyMaskFunction$LWS(function whenDefined$LWS(...args$LWS) {
    if (this !== customElements$LWS) {
      ...
      return PromiseReject$LWS(new TypeErrorCtor$1$LWS(ERR_ILLEGAL_INVOCATION$LWS));
    }
...
function patchHTMLElement$LWS(globalObject$LWS, registry$LWS) {
  ...
  globalObject$LWS.HTMLElement = proxyMaskFunction$LWS(function HTMLElement$LWS() {
    if (new.target === undefined) {
      throw new TypeErrorCtor$1$LWS(ERR_NO_NEW_OP_HTML_ELEMENT$LWS);
    }
    ...
    defineProperty(target$LWS, key$LWS, desc$LWS) {
      ...
      if (key$LWS === LOCKER_ORIGINAL_HTML_ELEMENT_CTOR_SYMBOL$LWS) {
        throw new TypeErrorCtor$1$LWS(ERR_ILLEGAL_PROPERTY_ACCESS$LWS);
      }

      return ReflectDefineProperty$1$LWS(target$LWS, key$LWS, desc$LWS);
    },
    ...
    get(target$LWS, key$LWS, receiver$LWS, handshake$LWS = false) {
      ...
      const result$LWS = ReflectGet$LWS(target$LWS, key$LWS, receiver$LWS); // Getting forged values of `LOCKER_ORIGINAL_HTML_ELEMENT_CTOR_SYMBOL`
    ...
    getOwnPropertyDescriptor(target$LWS, key$LWS) {
      const result$LWS = ReflectGetOwnPropertyDescriptor$LWS(target$LWS, key$LWS); // Getting forged descriptors of handshake properties is not allowed.
    ...
    has(target$LWS, key$LWS) {
      ...
      if (result$LWS) {
        handshakeOriginalHTMLElementCtorFlag$LWS = false; // Checking the existence of forged `LOCKER_ORIGINAL_HTML_ELEMENT_CTOR_SYMBOL`
        // properties is not allowed.
...
function triggerAttributeChangedCallbackDuringUpgrade$LWS(instance$LWS, originalDefinition$LWS) {
  ...
  const attributeChangedCallback$LWS = observedAttributes$LWS.size ? originalDefinition$LWS.attributeChangedCallback : undefined; // istanbul ignore else: current tests have no way of expressing a state that would cause this condition to evaluate false
  ...
  if (attributeChangedCallback$LWS) {
    ...
    observedAttributes$LWS.forEach(name$LWS => {
      if (ReflectApply$1$LWS(_ElementProtoHasAttribute$LWS, instance$LWS, [name$LWS])) {
        const newValue$LWS = ReflectApply$1$LWS(ElementProtoGetAttribute$LWS, instance$LWS, [name$LWS]);
        ReflectApply$1$LWS(attributeChangedCallback$LWS, instance$LWS, [name$LWS, null, newValue$LWS]);
      }
    });
  }
}
...
function getSandboxCustomElementRegistry$LWS(document$LWS, key$LWS) {
  ...
  if (registries$LWS === undefined) {
    registries$LWS = toSafeMap$1$LWS(new MapCtor$1$LWS());
...
function patchGlobalObject$LWS(document$LWS, globalObject$LWS) {
  ...
  const isCustomElementRegistryPatched$LWS = isProxyMaskedFunction$LWS(originalGet$LWS); // `originalHTMLElementCtorCache` must be set BEFORE
  // `getGlobalCustomElementRegistry()` is called.

  if (isHTMLElementCtorPatched$LWS) {
    originalHTMLElementCtor$LWS = getOriginalHTMLElementCtor$LWS(originalHTMLElementCtor$LWS); // istanbul ignore if: currently unreachable via tests

    if (typeof originalHTMLElementCtor$LWS !== 'function') {
      throw new TypeErrorCtor$1$LWS('Invalid HTMLElement constructor.');
    }
...
const attributeDistortionFactoriesCache$LWS = toSafeMap$1$LWS(new MapCtor$1$LWS());
const sandboxAttributeDistortionRegistryCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
  ...
  return function distortionAttrValueSetter$LWS(record$LWS) {
    return [originalAttrValueSetter$LWS, function value$LWS(val$LWS) {
      ...
      if (ownerElement$LWS) {
        ...
        const distortion$LWS = getAttributeDistortion$LWS(record$LWS, ownerElement$LWS, attrName$LWS, normalizedNamespace$LWS); // istanbul ignore if: coverage missing, needs investigation
...
function registerEventTargetRestriction$LWS(record$LWS, EventTargetCtor$LWS, eventName$LWS) {
  ...
  const {
    [eventName$LWS]: restrictedEventTargetCtors$LWS = toSafeWeakSet$1$LWS(new WeakSetCtor$1$LWS())
...
function createEventHandlerExceptionMessage$LWS(instanceOrProto$LWS, eventName$LWS) {
  ...
  const safeDesc$LWS = ReflectGetOwnPropertyDescriptor$LWS(instanceOrProto$LWS.constructor, 'name'); // istanbul ignore else: needs default platform behavior test
...
function createEventDistortionFactory$LWS(eventHandlerTarget$LWS, eventListenerTarget$LWS, eventName$LWS) {
  ...
  const originalEventHandlerSetter$LWS = ObjectLookupOwnSetter$LWS(eventHandlerTarget$LWS, onEventHandlerName$LWS); // istanbul ignore if: currently unreachable via tests
...
function initDistortionCSSStyleRuleStyleGetter$LWS({
  ...
  const distortionEntry$LWS = [originalStyleGetter$LWS, function style$LWS() {
    return trackAsLiveTarget$LWS(ReflectApply$1$LWS(originalStyleGetter$LWS, this, []));
  }];
...
function initDistortionCustomElementRegistryDefine$LWS({
  ...
  var _CustomElementRegistr$LWS; // Next, we MUST use a reference to the now patched version of this API method,
  ...
  const originalCustomElementsDefine$LWS = CustomElementRegistry$LWS == null ? void 0 : (_CustomElementRegistr$LWS = CustomElementRegistry$LWS.prototype) == null ? void 0 : _CustomElementRegistr$LWS.define; // istanbul ignore if: this is a safety precaution, but currently unreachable via tests
...
function initDistortionCustomElementRegistryGet$LWS({
  ...
  var _CustomElementRegistr2$LWS; // Next, we MUST use a reference to the now patched version of this API method,
  // or else we'll end up attempting to distort the wrong definition.
  // istanbul ignore next: optional chaining and nullish coalescing results in an expansion that contains an unreachable "void 0" branch for every occurrence of the operator


  const originalCustomElementsGet$LWS = CustomElementRegistry$LWS == null ? void 0 : (_CustomElementRegistr2$LWS = CustomElementRegistry$LWS.prototype) == null ? void 0 : _CustomElementRegistr2$LWS.get; // istanbul ignore if: this is a safety precaution, but currently unreachable via tests
...
function initDistortionCustomElementRegistryWhenDefined$LWS({
  ...
  var _CustomElementRegistr3$LWS; // Next, we MUST use a reference to the now patched version of this API method,
  // or else we'll end up attempting to distort the wrong definition.
  // istanbul ignore next: optional chaining and nullish coalescing results in an expansion that contains an unreachable "void 0" branch for every occurrence of the operator


  const originalCustomElementsWhenDefined$LWS = CustomElementRegistry$LWS == null ? void 0 : (_CustomElementRegistr3$LWS = CustomElementRegistry$LWS.prototype) == null ? void 0 : _CustomElementRegistr3$LWS.whenDefined; // istanbul ignore if: this is just a safeguard and not reachable in the test environment
...
function initDistortionDocumentCreateElement$LWS({
  ...
  return function distortionDocumentCreateElement$LWS({
    ...
    return [originalDocumentCreateElement$LWS, function (...args$LWS) {
      const {
        0: tagName$LWS
      } = args$LWS; // Slow path for potential custom elements that might be registered
      // in the sandbox's virtual custom element registry.

      if (ReflectApply$1$LWS(StringProtoIncludes$LWS, tagName$LWS, ['-'])) {
      ...
      return ReflectApply$1$LWS(originalDocumentCreateElement$LWS, this, args$LWS);
    }];
  };
}
...
function initDistortionDocumentCreateElementNS$LWS({
  ...
  return function distortionDocumentCreateElementNS$LWS({
    ...
    return [originalDocumentCreateElementNS$LWS, function (...args$LWS) {
      const {
        1: tagName$LWS
      } = args$LWS; // Slow path for potential custom elements that might
      ...
      return ReflectApply$1$LWS(originalDocumentCreateElementNS$LWS, this, args$LWS);
    }];
  };
}
      ...
      if (args$LWS.length > 2) {
        ...
        if (unsanitizedValue$LWS !== null && unsanitizedValue$LWS !== undefined) {
          ...
          if (ReflectApply$1$LWS(StringProtoToLowerCase$LWS, command$LWS, []) === 'inserthtml') {
            ...
            args$LWS[2] = lwsInternalPolicy$LWS.createHTML(unsanitizedValue$LWS, key$LWS, 0
            /* ContentType.HTML */
            );
          }
        }
  ...
  return function distortionDOMParserParseFromString$LWS({
    ...
    return [originalParseFromString$LWS, function parseFromString$LWS(...args$LWS) {
      ...
      if (args$LWS.length >= 2) {
        ...
        const mimeType$LWS = toString$LWS(args$LWS[1]); // This must be called to signal to the virtual
        // CustomElementRegistry that the next thing created
        // MAY CONTAIN a custom element, which must be marked for
        // association to this sandbox.

        setCustomElementsRegistry$LWS(document$LWS, key$LWS);
        args$LWS[0] = // If the provided mimeType indicates that the first
        // argument is an svg, use the svg sanitizer instead of
        // the default sanitizer.
        mimeType$LWS === 'image/svg+xml' ? sanitizeSvgInnerHtml$LWS(string$LWS) : // If the provided mimeType indicates that the
        // first argument is xml, there's nothing to do.
        mimeType$LWS === 'application/xhtml+xml' || mimeType$LWS === 'application/xml' || mimeType$LWS === 'text/xml' ? lwsInternalPolicy$LWS.createHTML(string$LWS, key$LWS, 2
        /* ContentType.XML */
        ) : lwsInternalPolicy$LWS.createHTML(string$LWS, key$LWS, 0
        /* ContentType.HTML */
        );
      }
...
const namedNodeMapToElementCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
  ...
  return function distortionElementInsertAdjacentHTML$LWS({
    ...
    return [originalInsertAdjacentHTML$LWS, function insertAdjacentHTML$LWS(...args$LWS) {
      ...
      if (args$LWS.length > 1) {
        ...
        // association to this sandbox.
        setCustomElementsRegistry$LWS(document$LWS, key$LWS);
        args$LWS[1] = lwsInternalPolicy$LWS.createHTML(args$LWS[1], key$LWS, 0
        /* ContentType.HTML */
        );
      }
...
function initDistortionElementOuterHTMLSetter$LWS({
  ...
  return function distortionElementOuterHTMLSetter$LWS({
    ...
    return [originalOuterHTMLSetter$LWS, function outerHTML$LWS(value$LWS) {
      ...
      setCustomElementsRegistry$LWS(document$LWS, key$LWS);
      ReflectApply$1$LWS(originalOuterHTMLSetter$LWS, this, [lwsInternalPolicy$LWS.createHTML(value$LWS, key$LWS, 0
      /* ContentType.HTML */
      )]);
    }];
  };
...
function initDistortionEventPathGetter$LWS({
  ...
  const originalPathGetter$LWS = ObjectLookupOwnGetter$1$LWS(Event$LWS.prototype, 'path'); // Chromium 109 removed Event.prototype.path:
...
function initDistortionHTMLElementDatasetGetter$LWS({
  ...
  const distortionEntry$LWS = [originalDatasetGetter$LWS, function dataset$LWS() {
    return trackAsLiveTarget$LWS(ReflectApply$1$LWS(originalDatasetGetter$LWS, this, []));
  }];
...
const descriptorCaches$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
...
function addBlockedPropertyDistortionFactoryInitializers$LWS({
  ...
  let descsCache$LWS = descriptorCaches$LWS.get(document$LWS); // istanbul ignore else: current tests have no way of expressing a state that would cause this condition to evaluate false

  if (descsCache$LWS === undefined) {
    descsCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
    descriptorCaches$LWS.set(document$LWS, descsCache$LWS);
  }

  let safeDescs$LWS = descsCache$LWS.get(proto$LWS); // istanbul ignore else: need a test for this on the same document but different namespace
...
const scriptURLs$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
...
function createScriptDistortion$LWS({
  ...
  const distortionName$LWS = `script${capitalizeFirstChar$LWS(attributeName$LWS)}`; // istanbul ignore next: optional chaining and nullish coalescing results in an expansion that contains an unreachable "void 0" branch for every occurrence of the operator
  ...
  const {
    ...
    [distortionName$LWS](url$LWS) {
      ...
      const evaluator$LWS = function evaluator$LWS(sourceText$LWS) {
        const ownerDoc$LWS = ReflectApply$1$LWS(NodeProtoOwnerDocumentGetter$LWS, targetElement$LWS, []);
        const defaultView$LWS = ReflectApply$1$LWS(DocumentProtoDefaultViewGetter$LWS, ownerDoc$LWS, []);
        const context$LWS = {
...
function initDistortionHTMLScriptElementSrcGetter$LWS({
  ...
  const distortionEntry$LWS = [originalSrcGetter$LWS, function src$LWS() {
    ...
    return (_getScriptURL$LWS = getScriptURL$LWS(this)) != null ? _getScriptURL$LWS : ReflectApply$1$LWS(originalSrcGetter$LWS, this, []);
  }];
...
function initDistortionJSONParse$LWS({
  ...
  return function distortionJSONParse$LWS({
    ...
    return [originalParse$LWS, function parse$LWS(...args$LWS) {
      ...
      if (!length$LWS) {
        return ReflectApply$1$LWS(originalParse$LWS, this, args$LWS);
      }

      const {
        0: text$LWS
      } = args$LWS;
      const originalReviver$LWS = length$LWS > 1 ? args$LWS[1] : undefined;
      const useReviver$LWS = typeof originalReviver$LWS === 'function';
      return ReflectApply$1$LWS(originalParse$LWS, this, [text$LWS, // eslint-disable-next-line no-shadow
      function reviver$LWS(key$LWS, value$LWS) {
        if (typeof value$LWS === 'object' && value$LWS !== null) {
          trackAsFastTarget$LWS(value$LWS); // POJOs are considered "live" by the heuristic in
          // `isTargetLive()`. Calling `trackAsLiveTarget()`
          // simply cuts out the heuristic and fast paths
          // tracking the target as "live".

          trackAsLiveTarget$LWS(value$LWS);
        }

        return useReviver$LWS ? ReflectApply$1$LWS(originalReviver$LWS, this, [key$LWS, value$LWS]) : value$LWS;
      }]);
    }];
  };
}
...
function initDistortionNodeTextContentGetter$LWS({
  ...
  const originalTextContentGetter$LWS = ObjectLookupOwnGetter$1$LWS(Node$LWS.prototype, 'textContent');
  const distortionEntry$LWS = [originalTextContentGetter$LWS, function textContent$LWS() {
    if (this instanceof HTMLScriptElement$LWS || this instanceof SVGScriptElement$LWS) {
      ...
      return (_getOriginalScriptTex$LWS = getOriginalScriptTextContent$LWS(this)) != null ? _getOriginalScriptTex$LWS : ReflectApply$1$LWS(originalTextContentGetter$LWS, this, []);
    }

    return ReflectApply$1$LWS(originalTextContentGetter$LWS, this, []);
  }];
  return function distortionHTMLScriptElementSrcGetter$LWS() {
    return distortionEntry$LWS;
  };
        ...
        if (!isScriptEvaluated$LWS(this)) {
          ...
          if (!isScriptURLEvaluatorHookDefined$LWS(this)) {
            defineScriptEvaluatorProperty$LWS(this, (context$LWS, defaultView$LWS, ownerDoc$LWS) => {
              ...
              ReflectDeleteProperty$1$LWS(this, 'textContent'); // Set the script's textContent immediately
            ...
            ReflectApply$1$LWS(originalTextContentSetter$LWS, this, [SCRIPT_HOOK_SOURCE_TEXT$LWS]);
          }
    ...
    return [originalCreateContextualFragment$LWS, function createContextualFragment$LWS(...args$LWS) {
      if (args$LWS.length) {
        ...
        if (tagString$LWS !== null && tagString$LWS !== undefined) {
          ...
          // for association to this sandbox.
          setCustomElementsRegistry$LWS(document$LWS, key$LWS);
          args$LWS[0] = lwsInternalPolicy$LWS.createHTML(tagString$LWS, key$LWS, 0
          /* ContentType.HTML */
          );
        }
      }
...
function initDistortionShadowRootInnerHTMLSetter$LWS({
  ...
  return function distortionShadowRootInnerHTMLSetter$LWS({
    ...
    return [originalInnerHTMLSetter$LWS, function innerHTML$LWS(value$LWS) {
      ...
      // association to this sandbox.
      setCustomElementsRegistry$LWS(document$LWS, key$LWS);
      ReflectApply$1$LWS(originalInnerHTMLSetter$LWS, this, [lwsInternalPolicy$LWS.createHTML(value$LWS, key$LWS, 0
      /* ContentType.HTML */
      )]);
    }];
  };
...
function createStorageProxy$LWS(storageTarget$LWS) {
  const proxy$LWS = new ProxyCtor$LWS(storageTarget$LWS, {
    ...
    get(target$LWS, key$LWS, receiver$LWS) {
      ...
      if (ObjectHasOwn$1$LWS(storage$LWS, markedKey$LWS)) {
    ...
    set(target$LWS, key$LWS, value$LWS) {
      ...
      const markedKey$LWS = prependStorageNamespaceMarker$LWS(key$LWS, namespace$LWS);
      ReflectApply$1$LWS(StorageProtoSetItem$LWS, storage$LWS, [markedKey$LWS, value$LWS]);
      return true;
    },
    ...
    defineProperty(target$LWS, key$LWS, unsafePartialDesc$LWS) {
      ...
      const markedKey$LWS = prependStorageNamespaceMarker$LWS(key$LWS, namespace$LWS);
      return ReflectDefineProperty$1$LWS(storage$LWS, markedKey$LWS, safeDesc$LWS);
    },
    ...
    deleteProperty(target$LWS, key$LWS) {
      ...
      const markedKey$LWS = prependStorageNamespaceMarker$LWS(key$LWS, namespace$LWS);
      return ReflectDeleteProperty$1$LWS(storage$LWS, markedKey$LWS);
    },
...
function createDistortionStorageFactoryInitializer$LWS(storageName$LWS) {
  return function initDistortionStorageFactory$LWS({
    ...
    } catch (_unused2$LWS) {} // istanbul ignore if: currently unreachable via tests
...
function initDistortionSVGElementStyleGetter$LWS({
  ...
  const originalStyleGetter$LWS = ObjectLookupOwnGetter$1$LWS(SVGElement$LWS.prototype, 'style');
  const distortionEntry$LWS = [originalStyleGetter$LWS, function style$LWS() {
    return trackAsLiveTarget$LWS(ReflectApply$1$LWS(originalStyleGetter$LWS, this, []));
  }];
...
function initDistortionSVGScriptElementHrefGetter$LWS({
  ...
  const originalHrefGetter$LWS = ObjectLookupOwnGetter$1$LWS(SVGScriptElement$LWS.prototype, 'href');
  const distortionEntry$LWS = [originalHrefGetter$LWS, function href$LWS() {
    var _getScriptURL2$LWS; // istanbul ignore next: optional chaining and nullish coalescing results in an expansion that contains unreachable branches


    return (_getScriptURL2$LWS = getScriptURL$LWS(this)) != null ? _getScriptURL2$LWS : ReflectApply$1$LWS(originalHrefGetter$LWS, this, []);
  }];
  ...
  const createFramesProxy$LWS = () => {
    ...
    const getFrameByIndexKey$LWS = key$LWS => {
      ...
      if (possibleIndex$LWS > -1 && NumberIsInteger$1$LWS(possibleIndex$LWS) && possibleIndex$LWS < ReflectApply$1$LWS(WindowLengthGetter$LWS, globalObject$LWS, [])) {
        const value$LWS = ObjectLookupOwnValue$LWS(globalObject$LWS, key$LWS); // istanbul ignore else: needs default platform behavior test
    ...
    class ShadowWindowPropertiesHandler$LWS extends ShadowFramesPrototypeHandler$LWS {
      ...
      ownKeys() {
        ...
        ReflectSetPrototypeOf$1$LWS(unsafeDescs$LWS, null);
...
function initDistortionWindowGetComputedStyle$LWS({
  ...
  const distortionEntry$LWS = [originalGetComputedStyle$LWS, function getComputedStyle$LWS(...args$LWS) {
    return trackAsLiveTarget$LWS(ReflectApply$1$LWS(originalGetComputedStyle$LWS, this, args$LWS));
  }];
...
function initDistortionXMLHttpRequestResponseGetter$LWS({
  ...
  return function distortionXMLHttpRequestResponseGetter$LWS({
    ...
    return [originalResponseGetter$LWS, function response$LWS() {
      const rawResponse$LWS = ReflectApply$1$LWS(originalResponseGetter$LWS, this, []); // This must be called to signal to the virtual
      // CustomElementRegistry that the next thing created
      // MAY CONTAIN a custom element, which must be marked for
      // association to this sandbox.

      setCustomElementsRegistry$LWS(document$LWS, key$LWS);
      return rawResponse$LWS instanceof Document$LWS ? sanitizeDocument$LWS(rawResponse$LWS, key$LWS) :
      /* istanbul ignore next: needs default platform behavior test */
      rawResponse$LWS;
    }];
  };
...
function initDistortionXMLHttpRequestResponseXMLGetter$LWS({
  ...
  return function distortionXMLHttpRequestResponseXMLGetter$LWS({
    ...
    return [originalResponseXMLGetter$LWS, function responseXML$LWS() {
      const rawResponseXML$LWS = ReflectApply$1$LWS(originalResponseXMLGetter$LWS, this, []); // This must be called to signal to the virtual
      // CustomElementRegistry that the next thing created
      // MAY CONTAIN a custom element, which must be marked for
      // association to this sandbox.
...
initDistortionDocumentDomainSetter$LWS, initDistortionDocumentOnsecuritypolicyviolation$LWS, initDistortionDocumentOpen$LWS, // Element
initDistortionElementAttachShadow$LWS, initDistortionElementAttributesGetter$LWS, initDistortionElementRemove$LWS, initDistortionElementReplaceChildren$LWS, initDistortionElementReplaceWith$LWS, // Function
...
initDistortionShadowRootModeGetter$LWS, // SharedWorker
initDistortionSharedWorkerCtor$LWS, initDistortionSharedWorkerProto$LWS, // Storage
initDistortionStorage$LWS, initDistortionStorageClear$LWS, initDistortionStorageGetItem$LWS, initDistortionStorageKey$LWS, initDistortionStorageLength$LWS, initDistortionStorageRemoveItem$LWS, initDistortionStorageSetItem$LWS, // SVGAnimateElement
...
initDistortionTrustedTypePolicyFactoryCreatePolicy$LWS, // Window
initDistortionWindowFetch$LWS, initDistortionWindowFramesGetter$LWS, initDistortionWindowGetComputedStyle$LWS, initDistortionWindowLengthGetter$LWS, initDistortionWindowOnsecuritypolicyviolation$LWS, initDistortionWindowOnstorage$LWS, initDistortionWindowOpen$LWS, initDistortionWindowPostMessage$LWS, initDistortionWindowStructuredClone$LWS, // Worker
...
initDistortionDocumentCookieGetter$LWS, initDistortionDocumentCookieSetter$LWS, initDistortionDocumentCreateElement$LWS, initDistortionDocumentCreateElementNS$LWS, initDistortionDocumentExecCommand$LWS, initDistortionDocumentReplaceChildren$LWS, // DOMParser
initDistortionDOMParserParseFromString$LWS, // CustomElementRegistry
initDistortionCustomElementRegistryDefine$LWS, initDistortionCustomElementRegistryGet$LWS, initDistortionCustomElementRegistryWhenDefined$LWS, // Element
initDistortionElementInnerHTMLSetter$LWS, initDistortionElementInsertAdjacentHTML$LWS, initDistortionElementOuterHTMLSetter$LWS, initDistortionElementSetAttribute$LWS, initDistortionElementSetAttributeNode$LWS, initDistortionElementSetAttributeNodeNS$LWS, initDistortionElementSetAttributeNS$LWS, initDistortionElementToggleAttribute$LWS, // Event
initDistortionEventComposedPath$LWS, initDistortionEventPathGetter$LWS, // EventTarget
initDistortionEventTargetAddEventListener$LWS, // HTMLElement
initDistortionHTMLElementCtor$LWS, // HTMLScriptElement,
...
initDistortionNodeValueSetter$LWS, initDistortionNodeTextContentGetter$LWS, initDistortionNodeTextContentSetter$LWS, // Range
initDistortionRangeCreateContextualFragment$LWS, // ShadowRoot
initDistortionShadowRootInnerHTMLSetter$LWS, // Storage
...
initDistortionSVGSetElementAttributeNameAttribute$LWS, // URL
initDistortionURLCreateObjectURL$LWS, // Window
initDistortionWindowSetInterval$LWS, initDistortionWindowSetTimeout$LWS, // XHR
...
const evalDistortionFactoryCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
const opaqueWindowPostMessageDistortionFactoryCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS()); // WebKit based browsers have a bug that prematurely removes distortion entries
...
function getDistortionFactories$LWS(_record$LWS) {
  ...
  addBlockedPropertyDistortionFactoryInitializers$LWS(_record$LWS, _SVGElement$LWS.prototype, SVGElementBlockedProperties$LWS, initializers$LWS); // istanbul ignore else: this is a safety precaution that is unreachable via tests
  ...
  patchGlobalObject$LWS(_document$LWS, _globalObject$LWS); // Reuse the `initializers` array as the `factories` array.
...
function proxyMaskFunctionDistortion$LWS({
  ...
  return proxyMaskFunction$LWS(distortionFunc$LWS, maskFunc$LWS, {
    apply: function (__target$LWS, thisArg$LWS, _args$LWS) {
      ...
      try {
        return ReflectApply$1$LWS(__target$LWS, thisArg$LWS, _args$LWS);
      } catch (error) {
        // istanbul ignore if: this is a safety precaution that is unreachable via tests
...
}()}`.includes('LOCKER_UNMINIFIED_FLAG'); // Character constants.

const CHAR_ELLIPSIS$LWS = '\u2026'; // Error message constants.
...
const DocumentProtoBodyGetter$LWS = ObjectLookupOwnGetter$LWS(_DocumentProto$LWS, 'body'); // The DOMException constructor was exposed in Edge 12 but wasn't invocable
  ...
  return function createHooksCallback$LWS(color$LWS, foreignCallableHooksCallback$LWS, _options$LWS) {
    ...
    function getTransferablePointer$LWS(originalTarget$LWS, foreignCallablePusher$LWS = foreignCallablePushTarget$LWS) {
      ...
      if (revokedProxyCallback$LWS && revokedProxyCallback$LWS(originalTarget$LWS)) {
        ...
        , targetFunctionArity$LWS, targetFunctionName$LWS, targetTypedArrayLength$LWS);
    ...
    const installPropertyDescriptorMethodWrappers$LWS = IS_IN_SHADOW_REALM$LWS ? unforgeableGlobalThisKeys$LWS => {
      ...
      const getUnforgeableGlobalThisGetter$LWS = shouldFixChromeBug$LWS ? __key$LWS => {
        ...
        if (globalThisGetter$LWS === undefined) {
          ...
          globalThisGetter$LWS = ReflectApply$LWS(FunctionProtoBind$LWS, // eslint-disable-next-line @typescript-eslint/no-use-before-define
      ...
      const wrapGetOwnPropertyDescriptors$LWS = originalFunc$LWS => new ProxyCtor$LWS(originalFunc$LWS, {
        apply(_originalFunc$LWS, thisArg$LWS, _args$LWS) {
          ...
          const _unsafeDescs$LWS = isFixingChromeBug$LWS ? // Create an empty property descriptor map
          ...
          const ownKeys$LWS = ReflectOwnKeys$LWS(isFixingChromeBug$LWS ? __target$LWS : _unsafeDescs$LWS);
          ...
          for (let _i$LWS = 0, {
            ...
            if (isLazyProp$LWS || isFixingChromeBug$LWS) {
              ...
              if (_unsafeDesc$LWS) {
                ...
                ReflectDeleteProperty$LWS(_unsafeDescs$LWS, ownKey$LWS);
              }
            }
          }
    ...
    function lookupForeignDescriptor$LWS(foreignTargetPointer$LWS, shadowTarget$LWS, __key$LWS) {
      ...
      if (_safeDesc$LWS === undefined) {
        ...
        if (_safeDesc$LWS) {
          ...
          _safeDesc$LWS.foreign = (typeof possibleProxy$LWS === 'object' && possibleProxy$LWS !== null || typeof possibleProxy$LWS === 'function') && proxyPointerCache$LWS.get(possibleProxy$LWS) !== undefined;
        }
      }
    ...
    class BoundaryProxyHandler$LWS {
      ...
      static passthruGetOwnPropertyDescriptorTrap(_shadowTarget$LWS, __key$LWS) {
        ...
        if (IS_NOT_IN_SHADOW_REALM$LWS && _safeDesc$LWS && (__key$LWS === LOCKER_NEAR_MEMBRANE_SYMBOL$LWS || __key$LWS === LOCKER_NEAR_MEMBRANE_SERIALIZED_VALUE_SYMBOL$LWS)) {
      ...
      static passthruSetTrap(_shadowTarget$LWS, __key$LWS, __value$LWS, __receiver$LWS) {
        ...
        if (IS_NOT_IN_SHADOW_REALM$LWS && (__key$LWS === LOCKER_NEAR_MEMBRANE_SYMBOL$LWS || __key$LWS === LOCKER_NEAR_MEMBRANE_SERIALIZED_VALUE_SYMBOL$LWS)) {
          throw new TypeErrorCtor$LWS(ERR_ILLEGAL_PROPERTY_ACCESS$LWS);
        }
    ...
    BoundaryProxyHandler$LWS.passthruGetTrap = IS_NOT_IN_SHADOW_REALM$LWS ? function (_shadowTarget$LWS, __key$LWS, __receiver$LWS) {
      ...
      ;
      const isNearMembraneSymbol$LWS = __key$LWS === LOCKER_NEAR_MEMBRANE_SYMBOL$LWS;
      const isNearMembraneSerializedValueSymbol$LWS = __key$LWS === LOCKER_NEAR_MEMBRANE_SERIALIZED_VALUE_SYMBOL$LWS;
      ...
      if (_result$LWS !== undefined && (isNearMembraneSymbol$LWS || isNearMembraneSerializedValueSymbol$LWS)) {
        throw new TypeErrorCtor$LWS(ERR_ILLEGAL_PROPERTY_ACCESS$LWS);
      }
    ...
    IS_NOT_IN_SHADOW_REALM$LWS ? (targetPointer$LWS, __key$LWS) => {
      targetPointer$LWS();
      const __target$LWS = selectedTarget$LWS;
      selectedTarget$LWS = undefined;
      let __value$LWS;
    ...
    (targetPointer$LWS, foreignCallableDescriptorsCallback$LWS) => {
      ...
      try {
        _unsafeDescs$LWS = ObjectGetOwnPropertyDescriptors$LWS(__target$LWS);
      } catch (error) {
        throw pushErrorAcrossBoundary$LWS(error);
      }

      const ownKeys$LWS = ReflectOwnKeys$LWS(_unsafeDescs$LWS);
      const {
        length: _length$LWS
      } = ownKeys$LWS;
...
class VirtualEnvironment$LWS {
  constructor(_options$LWS) {
    ...
    redCallableGetLazyPropertyDescriptorStateByTarget$LWS, noop$LWS, // redCallableGetPropertyValue,
    redCallableGetTargetIntegrityTraits$LWS, redCallableGetToStringTagOfTarget$LWS, redCallableInstallErrorPrepareStackTrace$LWS, noop$LWS, // redCallableInstallLazyPropertyDescriptors,
    noop$LWS, // redCallableIsTargetLive,
    ...
    blueCallableIsTargetLive$LWS, noop$LWS, // blueCallableIsTargetRevoked,
    noop$LWS, // blueCallableSerializeTarget,,
    blueCallableSetLazyPropertyDescriptorStateByTarget$LWS, noop$LWS, // blueCallableTrackAsFastTarget,
    ...
    this.redCallableDefineProperties = (targetPointer$LWS, ...descriptorTuples$LWS) => {
      ...
      ReflectApply$LWS(redCallableDefineProperties$LWS, undefined, _args$LWS);
    };
    ...
    this.redCallableInstallLazyPropertyDescriptors = (targetPointer$LWS, ...ownKeysAndUnforgeableGlobalThisKeys$LWS) => {
      ...
      ReflectApply$LWS(redCallableInstallLazyPropertyDescriptors$LWS, undefined, _args$LWS);
    };
...
function removeWindowDescriptors$LWS(_unsafeDescs$LWS) {
  ...
  ReflectDeleteProperty$LWS(_unsafeDescs$LWS, 'window'); // Remove other browser specific unforgeables.
...
function createIframeVirtualEnvironment$LWS(_globalObject$LWS, _providedOptions$LWS) {
  ...
  if (keepAlive$LWS) {
    aliveIframes$LWS.add(iframe$LWS); // @TODO: Temporary hack to preserve the document reference in Firefox.
...
function createEvalHelpersFactoryArgs$LWS(_record$LWS) {
  ...
  const scriptSrcGetterDistortion$LWS = _distortions$LWS.get(isRootRecord$LWS ? HTMLScriptElementProtoSrcGetter$LWS : ObjectLookupOwnGetter$1$LWS(HTMLScriptElementProto$LWS, 'src'));
  ...
  function genStep$LWS(_resolve$LWS, _reject$LWS, next$LWS, thrower$LWS, genMethodWrapper$LWS, arg$LWS) {
    ...
    if (info$LWS.done) {
      ...
      ReflectApply$1$LWS(PromiseProtoThen$LWS, PromiseResolve$LWS(__value$LWS), [next$LWS, thrower$LWS]);
    }
  }
  ...
  function loadPromise$LWS(_element$LWS, urlAsString$LWS) {
    const _promise$LWS = new PromiseCtor$LWS((_resolve$LWS, _reject$LWS) => {
      function onerror$LWS(_event$LWS) {
        ReflectApply$1$LWS(EventTargetProtoRemoveEventListener$LWS, _element$LWS, ['error', onerror$LWS]);
        ReflectApply$1$LWS(EventTargetProtoRemoveEventListener$LWS, _element$LWS, ['load', onload$LWS]);
        ReflectApply$1$LWS(EventProtoStopPropagation$LWS, _event$LWS, []);
      ...
      function onload$LWS() {
        ...
        _resolve$LWS(undefined);
      }

      ReflectApply$1$LWS(EventTargetProtoAddEventListener$LWS, _element$LWS, ['error', onerror$LWS]);
      ReflectApply$1$LWS(EventTargetProtoAddEventListener$LWS, _element$LWS, ['load', onload$LWS]);
    });
    ...
    ReflectApply$1$LWS(NodeProtoAppendChild$1$LWS, head$LWS, [_element$LWS]);
    return _promise$LWS;
  }
  ...
  function baseGenToAsync$LWS(genNextWrapper$LWS, genThrowWrapper$LWS) {
    ...
    /* init */
      ...
      if (typeof iterator$LWS !== 'function') {
        throw new TypeErrorCtor$1$LWS('Object is not iterable.');
      }
    ...
    /* step */
      ...
      return _state$LWS.sync ? new PromiseCtor$LWS(_resolve$LWS => {
        ...
        _resolve$LWS();
      }) : ReflectApply$1$LWS(PromiseProtoThen$LWS, _result$LWS, [step$LWS => {
  ...
  function loadScript$LWS(_thisArg$LWS, _url$LWS) {
    ...
    for (let _i$LWS = 0, {
      ...
      const script$LWS = scripts$LWS[_i$LWS]; // istanbul ignore else: current tests have no way of expressing a state that would cause this condition to evaluate false

      if (ReflectApply$1$LWS(scriptSrcGetterDistortion$LWS, script$LWS, []) === resolvedURL$LWS) {
        var _resourceStatusCache$$LWS;

        const status$LWS = (_resourceStatusCache$$LWS = resourceStatusCache$LWS.get(script$LWS)) != null ? _resourceStatusCache$$LWS : 0
    ...
    const script$LWS = ReflectApply$1$LWS(DocumentProtoCreateElement$1$LWS, _document$LWS, ['script']);
  ...
  function loadStyle$LWS(_thisArg$LWS, _url$LWS) {
    ...
    if (link$LWS) {
      ...
      const _promise$LWS = status$LWS === 2
      /* ResourceLoaderStatus.Loading */
      ? resourcePromiseCache$LWS.get(link$LWS) : undefined;
      return _promise$LWS != null ? _promise$LWS : PromiseResolve$LWS(undefined);
    }

    link$LWS = ReflectApply$1$LWS(DocumentProtoCreateElement$1$LWS, _document$LWS, ['link']);
...
const IFRAME_KEEP_ALIVE_FLAG$LWS = LOCKER_UNMINIFIED_FLAG$1$LWS && !false; // Fast path non-configurable document, location, and window objects in the
...
const rendererFactoryToRendererCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
  ...
  return _sourceText$LWS => {
    if (virtualEnvironment$LWS === undefined) {
      ...
      setEvalContext$LWS(redEvalHelpersFactory$LWS => {
        const helpers$LWS = ReflectApply$1$LWS(redEvalHelpersFactory$LWS, undefined, createEvalHelpersFactoryArgs$LWS(_record$LWS));
...
function createVirtualEnvironment$LWS(_record$LWS) {
  ...
  return createIframeVirtualEnvironment$LWS(_globalObject$LWS, {
    ...
    signSourceCallback: _sourceText$LWS => trusted$LWS.createScript(_sourceText$LWS)
  });
}
...
function createRootWindowSandboxRecord$LWS({
  ...
  const entries$LWS = createDistortionEntries$LWS(_record$LWS, getDistortionFactories$LWS(_record$LWS)); // Add distortions to the root window's distortion map.
...
export { CORE_SANDBOX_KEY$LWS as CORE_SANDBOX_KEY, createRootWindowSandboxRecord$LWS as createRootWindowSandboxRecord, evaluateInCoreSandbox$LWS as evaluateInCoreSandbox, evaluateInSandbox$LWS as evaluateInSandbox };
