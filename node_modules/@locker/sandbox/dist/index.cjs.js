...
const LOCKER_ORIGINAL_HTML_ELEMENT_CTOR_SYMBOL$LWS = shared$LWS.SymbolFor('@@lockerOriginalHTMLElementCtor');
...
const originalHTMLElementCtorCache$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
...
class VirtualRegistry$LWS {
  ...
  newCtor(instance$LWS) {
    ...
    if (definition$LWS === undefined || typeof definition$LWS.PivotCtor !== 'function') {
      ...
      try {
        tagName$LWS = shared$LWS.ReflectApply(sharedDom$LWS.ElementProtoTagNameGetter, instance$LWS, []); // eslint-disable-next-line no-empty
  ...
  scheduleOrUpgrade(instance$LWS, tagName$LWS, originalDefinition$LWS) {
    ...
    if (definition$LWS) {
      ...
      shared$LWS.ReflectSetPrototypeOf(instance$LWS, this._HTMLElement.prototype);
    }
  }
...
function getNodeRegistry$LWS(document$LWS, node$LWS) {
  ...
  const ownerDoc$LWS = shared$LWS.ReflectApply(sharedDom$LWS.NodeProtoOwnerDocumentGetter, node$LWS, []); // istanbul ignore if: it's unclear how this could actually happen, if the node is coming from parsed/sanitized html.
...
function getObservedAttributesList$LWS(baseDefinition$LWS, sourceDefinition$LWS) {
  ...
  return shared$LWS.toSafeSet(new shared$LWS.SetCtor([...sourceDefinition$LWS.observedAttributes].filter( // `baseDefinition.observedAttributes` is a safe Set.
...
function patchAttributes$LWS(instance$LWS, originalDefinition$LWS, pivotDefinition$LWS) {
  ...
  instance$LWS.removeAttribute = shared$LWS.proxyMaskFunction(function removeAttribute$LWS(name$LWS) {
  ...
  instance$LWS.setAttribute = shared$LWS.proxyMaskFunction(function setAttribute$LWS(name$LWS, value$LWS) {
  ...
  instance$LWS.toggleAttribute = shared$LWS.proxyMaskFunction(function toggleAttribute$LWS(name$LWS) {
    const args$LWS = [name$LWS];
...
function patchCustomElementRegistry$LWS(globalObject$LWS, registry$LWS) {
  ...
  CustomElementRegistryProto$LWS.get = shared$LWS.proxyMaskFunction(function get$LWS(...args$LWS) {
  ...
  CustomElementRegistryProto$LWS.define = shared$LWS.proxyMaskFunction(function define$LWS(...args$LWS) {
    if (this !== customElements$LWS) {
      // This is more restricted than native behavior because
  ...
  CustomElementRegistryProto$LWS.whenDefined = shared$LWS.proxyMaskFunction(function whenDefined$LWS(...args$LWS) {
    if (this !== customElements$LWS) {
...
function patchHTMLElement$LWS(globalObject$LWS, registry$LWS) {
  ...
  globalObject$LWS.HTMLElement = shared$LWS.proxyMaskFunction(function HTMLElement$LWS() {
    ...
    defineProperty(target$LWS, key$LWS, desc$LWS) {
      ...
      if (key$LWS === LOCKER_ORIGINAL_HTML_ELEMENT_CTOR_SYMBOL$LWS) {
        throw new shared$LWS.TypeErrorCtor(shared$LWS.ERR_ILLEGAL_PROPERTY_ACCESS);
      }

      return shared$LWS.ReflectDefineProperty(target$LWS, key$LWS, desc$LWS);
    },
    ...
    get(target$LWS, key$LWS, receiver$LWS, handshake$LWS = false) {
      ...
      const result$LWS = shared$LWS.ReflectGet(target$LWS, key$LWS, receiver$LWS); // Getting forged values of `LOCKER_ORIGINAL_HTML_ELEMENT_CTOR_SYMBOL`
    ...
    getOwnPropertyDescriptor(target$LWS, key$LWS) {
      const result$LWS = shared$LWS.ReflectGetOwnPropertyDescriptor(target$LWS, key$LWS); // Getting forged descriptors of handshake properties is not allowed.
    ...
    has(target$LWS, key$LWS) {
      const result$LWS = shared$LWS.ReflectHas(target$LWS, key$LWS);
      const isOriginalHTMLElementCtorSymbol$LWS = key$LWS === LOCKER_ORIGINAL_HTML_ELEMENT_CTOR_SYMBOL$LWS;
    ...
    set(target$LWS, key$LWS, value$LWS, receiver$LWS) {
      ...
      return shared$LWS.ReflectSet(target$LWS, key$LWS, value$LWS, receiver$LWS);
    }
...
function patchGlobalObject$LWS(document$LWS, globalObject$LWS) {
  ...
  const isHTMLElementCtorPatched$LWS = shared$LWS.isProxyMaskedFunction(originalHTMLElementCtor$LWS);
  const isCustomElementRegistryPatched$LWS = shared$LWS.isProxyMaskedFunction(originalGet$LWS); // `originalHTMLElementCtorCache` must be set BEFORE
  ...
  if (isHTMLElementCtorPatched$LWS) {
    ...
    if (typeof originalHTMLElementCtor$LWS !== 'function') {
      throw new shared$LWS.TypeErrorCtor('Invalid HTMLElement constructor.');
    }
...
function createEventHandlerExceptionMessage$LWS(instanceOrProto$LWS, eventName$LWS) {
  ...
  const safeDesc$LWS = shared$LWS.ReflectGetOwnPropertyDescriptor(instanceOrProto$LWS.constructor, 'name'); // istanbul ignore else: needs default platform behavior test
...
function createEventDistortionFactory$LWS(eventHandlerTarget$LWS, eventListenerTarget$LWS, eventName$LWS) {
  ...
  const originalEventHandlerSetter$LWS = shared$LWS.ObjectLookupOwnSetter(eventHandlerTarget$LWS, onEventHandlerName$LWS); // istanbul ignore if: currently unreachable via tests
      ...
      if (args$LWS.length > 2) {
        ...
        if (unsanitizedValue$LWS !== null && unsanitizedValue$LWS !== undefined) {
          ...
          if (shared$LWS.ReflectApply(shared$LWS.StringProtoToLowerCase, command$LWS, []) === 'inserthtml') {
            ...
            args$LWS[2] = trustedTypes$LWS.lwsInternalPolicy.createHTML(unsanitizedValue$LWS, key$LWS, 0
            /* ContentType.HTML */
            );
          }
        }
  ...
  return function distortionDOMParserParseFromString$LWS({
    ...
    return [originalParseFromString$LWS, function parseFromString$LWS(...args$LWS) {
      ...
      if (args$LWS.length >= 2) {
        ...
        const mimeType$LWS = shared$LWS.toString(args$LWS[1]); // This must be called to signal to the virtual
        // CustomElementRegistry that the next thing created
        ...
        mimeType$LWS === 'image/svg+xml' ? htmlSanitizer$LWS.sanitizeSvgInnerHtml(string$LWS) : // If the provided mimeType indicates that the
        // first argument is xml, there's nothing to do.
        mimeType$LWS === 'application/xhtml+xml' || mimeType$LWS === 'application/xml' || mimeType$LWS === 'text/xml' ? trustedTypes$LWS.lwsInternalPolicy.createHTML(string$LWS, key$LWS, 2
        /* ContentType.XML */
        ) : trustedTypes$LWS.lwsInternalPolicy.createHTML(string$LWS, key$LWS, 0
        /* ContentType.HTML */
        );
      }
  ...
  return function distortionElementInnerHTMLSetter$LWS({
    ...
    return [originalInnerHTMLSetter$LWS, function innerHTML$LWS(value$LWS) {
      ...
      if (!isOwnerXMLDocument$LWS) {
        ...
        setCustomElementsRegistry$LWS(document$LWS, key$LWS);
        value$LWS = this instanceof SVGElement$LWS ? htmlSanitizer$LWS.sanitizeSvgInnerHtml(this, value$LWS) : htmlSanitizer$LWS.sanitize(value$LWS, key$LWS);
      }
  ...
  return function distortionElementInsertAdjacentHTML$LWS({
    ...
    return [originalInsertAdjacentHTML$LWS, function insertAdjacentHTML$LWS(...args$LWS) {
      ...
      if (args$LWS.length > 1) {
        ...
        // association to this sandbox.
        setCustomElementsRegistry$LWS(document$LWS, key$LWS);
        args$LWS[1] = trustedTypes$LWS.lwsInternalPolicy.createHTML(args$LWS[1], key$LWS, 0
        /* ContentType.HTML */
        );
      }
...
function initDistortionElementOuterHTMLSetter$LWS({
  ...
  return function distortionElementOuterHTMLSetter$LWS({
    ...
    return [originalOuterHTMLSetter$LWS, function outerHTML$LWS(value$LWS) {
      ...
      setCustomElementsRegistry$LWS(document$LWS, key$LWS);
      shared$LWS.ReflectApply(originalOuterHTMLSetter$LWS, this, [trustedTypes$LWS.lwsInternalPolicy.createHTML(value$LWS, key$LWS, 0
      /* ContentType.HTML */
      )]);
    }];
  };
...
function initDistortionEventPathGetter$LWS({
  ...
  const originalPathGetter$LWS = shared$LWS.ObjectLookupOwnGetter(Event$LWS.prototype, 'path'); // Chromium 109 removed Event.prototype.path:
...
function createScriptDistortion$LWS({
  ...
  const distortionName$LWS = `script${shared$LWS.capitalizeFirstChar(attributeName$LWS)}`; // istanbul ignore next: optional chaining and nullish coalescing results in an expansion that contains an unreachable "void 0" branch for every occurrence of the operator
  ...
  const {
    ...
    [distortionName$LWS](url$LWS) {
      ...
      trustedTypes$LWS.lwsInternalPolicy.createScriptURL(url$LWS, evaluator$LWS, targetElement$LWS);
    }
...
function initDistortionJSONParse$LWS({
  ...
  return function distortionJSONParse$LWS({
    ...
    return [originalParse$LWS, function parse$LWS(...args$LWS) {
      ...
      if (!length$LWS) {
        return shared$LWS.ReflectApply(originalParse$LWS, this, args$LWS);
      }
      ...
      return shared$LWS.ReflectApply(originalParse$LWS, this, [text$LWS, // eslint-disable-next-line no-shadow
      function reviver$LWS(key$LWS, value$LWS) {
        if (typeof value$LWS === 'object' && value$LWS !== null) {
          ...
          shared$LWS.trackAsLiveTarget(value$LWS);
        }

        return useReviver$LWS ? shared$LWS.ReflectApply(originalReviver$LWS, this, [key$LWS, value$LWS]) : value$LWS;
      }]);
    }];
  };
}
...
function initDistortionNodeTextContentGetter$LWS({
  ...
  const distortionEntry$LWS = [originalTextContentGetter$LWS, function textContent$LWS() {
    if (this instanceof HTMLScriptElement$LWS || this instanceof SVGScriptElement$LWS) {
      ...
      return (_getOriginalScriptTex$LWS = sharedDom$LWS.getOriginalScriptTextContent(this)) != null ? _getOriginalScriptTex$LWS : shared$LWS.ReflectApply(originalTextContentGetter$LWS, this, []);
    }
  ...
  return function distortionNodeTextContentSetter$LWS(record$LWS) {
    ...
    return [originalTextContentSetter$LWS, function textContent$LWS(value$LWS) {
      ...
      if (this instanceof Attr$LWS) {
        ...
        if (!sharedDom$LWS.isTextContentEvaluatorHookDefined(this)) {
          ...
          sharedDom$LWS.defineScriptAccessorProperty(this, 'textContent', distortedTextContentGetter$LWS, originalTextContentSetter$LWS);
        } // Cache the original textContent value to mask the evaluator
        // hook source text.


        sharedDom$LWS.setOriginalScriptTextContent(this, valueAsString$LWS);

        if (!sharedDom$LWS.isScriptEvaluated(this)) {
          // Skip textContent evaluation if script URL is already
          // specified.
          if (!sharedDom$LWS.isScriptURLEvaluatorHookDefined(this)) {
            sharedDom$LWS.defineScriptEvaluatorProperty(this, (context$LWS, defaultView$LWS, ownerDoc$LWS) => {
              sharedDom$LWS.deleteOriginalTextContent(this);
              shared$LWS.ReflectDeleteProperty(this, 'textContent'); // Set the script's textContent immediately
            ...
            shared$LWS.ReflectApply(originalTextContentSetter$LWS, this, [sharedDom$LWS.SCRIPT_HOOK_SOURCE_TEXT]);
          }
    ...
    return [originalCreateContextualFragment$LWS, function createContextualFragment$LWS(...args$LWS) {
      if (args$LWS.length) {
        ...
        if (tagString$LWS !== null && tagString$LWS !== undefined) {
          ...
          // for association to this sandbox.
          setCustomElementsRegistry$LWS(document$LWS, key$LWS);
          args$LWS[0] = trustedTypes$LWS.lwsInternalPolicy.createHTML(tagString$LWS, key$LWS, 0
          /* ContentType.HTML */
          );
        }
      }
...
function initDistortionShadowRootInnerHTMLSetter$LWS({
  ...
  return function distortionShadowRootInnerHTMLSetter$LWS({
    ...
    return [originalInnerHTMLSetter$LWS, function innerHTML$LWS(value$LWS) {
      ...
      // association to this sandbox.
      setCustomElementsRegistry$LWS(document$LWS, key$LWS);
      shared$LWS.ReflectApply(originalInnerHTMLSetter$LWS, this, [trustedTypes$LWS.lwsInternalPolicy.createHTML(value$LWS, key$LWS, 0
      /* ContentType.HTML */
      )]);
    }];
  };
...
function initDistortionSVGScriptElementHrefGetter$LWS({
  ...
  const distortionEntry$LWS = [originalHrefGetter$LWS, function href$LWS() {
    ...
    return (_getScriptURL2$LWS = getScriptURL$LWS(this)) != null ? _getScriptURL2$LWS : shared$LWS.ReflectApply(originalHrefGetter$LWS, this, []);
  }];
  ...
  const createFramesProxy$LWS = () => {
    ...
    const getFrameByIndexKey$LWS = key$LWS => {
      ...
      if (possibleIndex$LWS > -1 && shared$LWS.NumberIsInteger(possibleIndex$LWS) && possibleIndex$LWS < shared$LWS.ReflectApply(sharedDom$LWS.WindowLengthGetter, globalObject$LWS, [])) {
        const value$LWS = shared$LWS.ObjectLookupOwnValue(globalObject$LWS, key$LWS); // istanbul ignore else: needs default platform behavior test
...
function initDistortionXMLHttpRequestResponseGetter$LWS({
  ...
  return function distortionXMLHttpRequestResponseGetter$LWS({
    ...
    return [originalResponseGetter$LWS, function response$LWS() {
      const rawResponse$LWS = shared$LWS.ReflectApply(originalResponseGetter$LWS, this, []); // This must be called to signal to the virtual
      // CustomElementRegistry that the next thing created
      // MAY CONTAIN a custom element, which must be marked for
      // association to this sandbox.

      setCustomElementsRegistry$LWS(document$LWS, key$LWS);
      return rawResponse$LWS instanceof Document$LWS ? htmlSanitizer$LWS.sanitizeDocument(rawResponse$LWS, key$LWS) :
      /* istanbul ignore next: needs default platform behavior test */
      rawResponse$LWS;
    }];
  };
...
function initDistortionXMLHttpRequestResponseXMLGetter$LWS({
  ...
  return function distortionXMLHttpRequestResponseXMLGetter$LWS({
    ...
    return [originalResponseXMLGetter$LWS, function responseXML$LWS() {
      const rawResponseXML$LWS = shared$LWS.ReflectApply(originalResponseXMLGetter$LWS, this, []); // This must be called to signal to the virtual
      // CustomElementRegistry that the next thing created
      // MAY CONTAIN a custom element, which must be marked for
      // association to this sandbox.

      setCustomElementsRegistry$LWS(document$LWS, key$LWS);
      return htmlSanitizer$LWS.sanitizeDocument(rawResponseXML$LWS, key$LWS);
    }];
  };
}
/*
...
const evalDistortionFactoryCache$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
const opaqueWindowPostMessageDistortionFactoryCache$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor()); // WebKit based browsers have a bug that prematurely removes distortion entries
...
function proxyMaskFunctionDistortion$LWS({
  ...
  return shared$LWS.proxyMaskFunction(distortionFunc$LWS, maskFunc$LWS, {
    apply: function (__target$LWS, thisArg$LWS, _args$LWS) {
      ...
      try {
        return shared$LWS.ReflectApply(__target$LWS, thisArg$LWS, _args$LWS);
      } catch (error) {
        // istanbul ignore if: this is a safety precaution that is unreachable via tests
    ...
    construct: function (__target$LWS, _args$LWS, newTarget$LWS) {
      ...
      try {
        return shared$LWS.ReflectConstruct(__target$LWS, _args$LWS, newTarget$LWS);
      } catch (error) {
        // istanbul ignore if: this is a safety precaution that is unreachable via tests
        if (LOCKER_DEBUG_MODE_INSTRUMENTATION_FLAG$LWS) {
          activity$LWS.error({
...
function createResourceLoadError$LWS(_url$LWS) {
  return new shared$LWS.LockerSecurityError(`platformResourceLoader error loading ${shared$LWS.enquote(_url$LWS)}.`);
}
...
function createEvalHelpersFactoryArgs$LWS(_record$LWS) {
  ...
  const scriptSrcGetterDistortion$LWS = _distortions$LWS.get(isRootRecord$LWS ? sharedDom$LWS.HTMLScriptElementProtoSrcGetter : shared$LWS.ObjectLookupOwnGetter(HTMLScriptElementProto$LWS, 'src'));
  const scriptSrcSetterDistortion$LWS = _distortions$LWS.get(isRootRecord$LWS ? sharedDom$LWS.HTMLScriptElementProtoSrcSetter : shared$LWS.ObjectLookupOwnSetter(HTMLScriptElementProto$LWS, 'src'));
  ...
  function genStep$LWS(_resolve$LWS, _reject$LWS, next$LWS, thrower$LWS, genMethodWrapper$LWS, arg$LWS) {
    ...
    if (info$LWS.done) {
      ...
      shared$LWS.ReflectApply(shared$LWS.PromiseProtoThen, shared$LWS.PromiseResolve(__value$LWS), [next$LWS, thrower$LWS]);
    }
  }

  function loadPromise$LWS(_element$LWS, urlAsString$LWS) {
    const _promise$LWS = new shared$LWS.PromiseCtor((_resolve$LWS, _reject$LWS) => {
      function onerror$LWS(_event$LWS) {
        shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoRemoveEventListener, _element$LWS, ['error', onerror$LWS]);
        shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoRemoveEventListener, _element$LWS, ['load', onload$LWS]);
        shared$LWS.ReflectApply(sharedDom$LWS.EventProtoStopPropagation, _event$LWS, []);
      ...
      shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoAddEventListener, _element$LWS, ['error', onerror$LWS]);
      shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoAddEventListener, _element$LWS, ['load', onload$LWS]);
    });
    ...
    shared$LWS.ReflectApply(sharedDom$LWS.NodeProtoAppendChild, head$LWS, [_element$LWS]);
    return _promise$LWS;
  }
  ...
  function baseGenToAsync$LWS(genNextWrapper$LWS, genThrowWrapper$LWS) {
    return new shared$LWS.PromiseCtor((_resolve$LWS, _reject$LWS) => {
    ...
    /* init */
      ...
      if (typeof iterator$LWS !== 'function') {
        throw new shared$LWS.TypeErrorCtor('Object is not iterable.');
      }
    ...
    /* step */
      ...
      return _state$LWS.sync ? new shared$LWS.PromiseCtor(_resolve$LWS => {
        _state$LWS.step = _result$LWS;
        _resolve$LWS();
      }) : shared$LWS.ReflectApply(shared$LWS.PromiseProtoThen, _result$LWS, [step$LWS => {
  ...
  function loadScript$LWS(_thisArg$LWS, _url$LWS) {
    const urlAsString$LWS = shared$LWS.toString(_url$LWS);
    ...
    const script$LWS = shared$LWS.ReflectApply(sharedDom$LWS.DocumentProtoCreateElement, _document$LWS, ['script']);
  ...
  function loadStyle$LWS(_thisArg$LWS, _url$LWS) {
    ...
    if (link$LWS) {
      ...
      return _promise$LWS != null ? _promise$LWS : shared$LWS.PromiseResolve(undefined);
    }

    link$LWS = shared$LWS.ReflectApply(sharedDom$LWS.DocumentProtoCreateElement, _document$LWS, ['link']);
...
const IFRAME_KEEP_ALIVE_FLAG$LWS = shared$LWS.LOCKER_UNMINIFIED_FLAG && !false; // Fast path non-configurable document, location, and window objects in the
...
const rendererFactoryToRendererCache$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
  ...
  return _sourceText$LWS => {
    if (virtualEnvironment$LWS === undefined) {
      ...
      setEvalContext$LWS(redEvalHelpersFactory$LWS => {
        const helpers$LWS = shared$LWS.ReflectApply(redEvalHelpersFactory$LWS, undefined, createEvalHelpersFactoryArgs$LWS(_record$LWS));
...
function createVirtualEnvironment$LWS(_record$LWS) {
  ...
  return createIframeVirtualEnvironment$LWS(_globalObject$LWS, {
    ...
    signSourceCallback: _sourceText$LWS => trustedTypes$LWS.trusted.createScript(_sourceText$LWS)
  });
}
